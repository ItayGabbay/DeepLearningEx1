...
def linear_activation_forward(A_prev, W, B, activation, use_batchnorm, dropout_rate):
    """
    ...
    :return:
        ...
        cache – A joint dictionary containing: linear_cache, activation_cache, bn_cache and dropout_cache
    ...
    if use_dropout:
        A, A_mask = apply_dropout(A, dropout_rate)

    return A, (linear_cache, activation_cache, bn_cache, A_mask)


def L_model_forward(X, parameters, use_batchnorm=0, dropout_rate=0):
    """
    ...
    :return:
       ...
       caches – A list of all the cache objects generated by the linear_forward function + dropout cache
    """
    ...
    AL, cache = linear_activation_forward(A, W, B, activation="softmax", use_batchnorm=0, dropout_rate=0)
    caches.append(cache)
